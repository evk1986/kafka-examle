...
public class GitHubEventsProducer {
    ...
    public GitHubEventsProducer(@Qualifier("gitEventKafkaTemplate") KafkaTemplate<String, GitEvent> kafka, RestTemplate restTemplate, GithubProperties git, CustomApplicationProperties applicationProperties) {
        this.kafka = kafka;
